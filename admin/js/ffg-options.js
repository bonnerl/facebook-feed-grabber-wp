...
jQuery( document ).ready(function( $ ) {
	...
	// Setting sections. 
	// This is actually more akin to an individual setting.
	ffgViews.section = Backbone.View.extend({

		// initialize : function(temp) {
			// if ( this.model.meta.key == 'verifyApp' ) {
			// 	var verifyApp = ffgViews.section.verifyApp({
			// 		model : this.model
			// 	});
			// }
		// },
	...
	ffgViews.section.verifyApp = Backbone.View.extend({
	...
	ffgViews.item = Backbone.View.extend({
		...
		template : function () {
			var template = $(this.model.meta.templateID).html();
